<div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{route('dashboard')}}"><img class="img-fluid" src="{{asset('public/assets/images/logo/logo.png')}}" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="{{route('edit-profile')}}"><i data-feather="user"></i><span>Account </span></a></li>
          ...
          <script class="empty-template" type="text/x-handlebars-template"></script>
