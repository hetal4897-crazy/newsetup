...
border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" width="100%" valign="top"><div class="definition-parent"><span><table align="center" width="100%" class="floated-none" style="float: none; text-align: center; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" role="presentation">
  <tbody><tr>
    <td align="center" style="padding: 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
      ...
      <img class="model" src="https://askpinkypromise.com/wp-content/uploads/2021/07/pinkypromise-logo.png" style="display: block; width: 90px; height: 41px; border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 0px;" alt="Logo" width="90" height="41">
...
border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" width="100%" valign="top"><div class="definition-parent"><span><table align="center" width="100%" class="floated-none" style="float: none; text-align: center; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" role="presentation">
  <tbody>
</tbody></table></span></div></td></tr></tbody></table><table class="row aw-stack" style="width: 100%; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 16px;" role="presentation"><tbody><tr><td class="container" style="padding: 30px; width: 100%; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse:
collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 16px;" width="100%" valign="top"><div class="definition-parent"><div class="text-element paragraph"><div style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 125%; font-weight: 400; text-align: left;"><h5>Thank you for booking a consultation on Pinky Promise with Dr. Trupti Shinde (MBBS, MS (Ob-Gyn), FMAS)!</h5>
...
<p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Your gynaecologist will call you from 02248903666 at your scheduled appointment time. She will be available to call again within the next 15 minutes after which if you are not available, the consultation will be cancelled and the fee will not be refunded to you.
</p>
  ...
  <div class="divider">
    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 16px;">
      <tbody>
          
          <tr>
              <th style="text-align: left;" >Booking Date</th><td>{{$user->date}} {{$user->time}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Name</th><td>{{$user->name}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Email</th><td>{{$user->email}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Phone</th><td>{{$user->phone}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">DOB</th><td>{{$user->dob}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Height</th><td>{{$user->height_in_feet}} feet {{$user->height_in_inches}} inches</td>
          </tr>
          <tr>
              <th style="text-align: left;">Weight</th><td>{{$user->weight}} kg</td>
          </tr>
          
          <tr>
              <th style="text-align: left;">Last Menstrual Period</th><td>{{$user->last_menstrual_period}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Problem you are facing </th><td>{{$user->problem_facing}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Medical history</th><td>{{$user->medical_history}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Allergies</th><td>{{$user->allergies}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Amount Paid</th><td>{{$user->amount}}</td>
          </tr>
          <tr>
              <th style="text-align: left;">Invoice Date</th><td>{{date("Y-m-d",strtotime($user->created_at))}}</td>
          </tr>
           <tr>
              <th style="text-align: left;">Payment Mode</th><td>online</td>
          </tr>
      </tbody>
    </table>
  </div>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
      <tbody><tr>
        <td align="center" style="padding: 0.625rem 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
          <!--[if mso]>&nbsp;<![endif]-->
          <a href="https://www.facebook.com/askpinkypromise/" style="display: inline-block; font-size: 0; vertical-align: top; margin: 0.25rem; height: 24px; width: 24px;" target="_blank" rel="noopener noreferrer">
          ...
          <!--[if mso]>&nbsp;<![endif]-->
          <a href="https://www.instagram.com/askpinkypromise/" style="display: inline-block; font-size: 0; vertical-align: top; margin: 0.25rem; height: 24px; width: 24px;" target="_blank" rel="noopener noreferrer">
          ...
          <!--[if mso]>&nbsp;<![endif]-->
          <a href="https://www.youtube.com/@pinkypromisehealth" style="display: inline-block; font-size: 0; vertical-align: top; margin: 0.25rem; height: 24px; width: 24px;" target="_blank" rel="noopener noreferrer">
          ...
          <!--[if mso]>&nbsp;<![endif]-->
          <a href="https://www.linkedin.com/company/pinky-promise-ltd/" style="display: inline-block; font-size: 0; vertical-align: top; margin: 0.25rem; height: 24px; width: 24px;" target="_blank" rel="noopener noreferrer">
...
<div style="text-align: center; color: rgb(124, 124, 124); font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 125%; font-weight: 400;">Call us: 02248903666</div>
<div style="text-align: center; color: rgb(124, 124, 124); font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 125%; font-weight: 400;">Pinky Promise Pvt. Ltd.</div>
